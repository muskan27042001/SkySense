...
class ForeCastAdapter : RecyclerView.Adapter<ForeCastHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ForeCastHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.fivedayforecastlayout, parent, false)
    ...
    override fun onBindViewHolder(holder: ForeCastHolder, position: Int) {
        ...
        val maxtemperatureRounded = maxtemperatureCelsius?.roundToInt()
        val maxtemperatureFormatted = maxtemperatureRounded.toString()
        ...
        val mintemperatureRounded = mintemperatureCelsius?.roundToInt()
        val mintemperatureFormatted = mintemperatureRounded.toString()
...
class ForeCastHolder(itemView: View) : ViewHolder(itemView){
   ...
   // val windspeed : TextView = itemView.findViewById(R.id.windSpeed)
    val mintemp : TextView = itemView.findViewById(R.id.daymintemp)
    val maxtemp : TextView = itemView.findViewById(R.id.daymaxtemp)
